...
describe('toggleMod', () => {
  ...
  it('should throw when source directory does not exist', () => {
    ...
    expect(() => toggleMod('/server', '/disabled-mods', 'MyMod', false))
      .toThrow('mod directory not found');
  });
  ...
  it('should throw when destination directory already exists', () => {
    ...
    expect(() => toggleMod('/server', '/disabled-mods', 'MyMod', false))
      .toThrow('directory already exists at destination');
  });
  ...
  it('should throw descriptive error on EACCES', () => {
    ...
    err.code = 'EACCES';
    mockFs.renameSync.mockImplementation(() => { throw err; });
  ...
  it('should include mod name in error messages', () => {
    ...
    expect(() => toggleMod('/server', '/disabled-mods', 'TestMod', false))
      .toThrow(/TestMod/);
  });
  ...
  it('should use correct action word (enable vs disable) in errors', () => {
    ...
    expect(() => toggleMod('/server', '/disabled-mods', 'Mod', false))
      .toThrow(/disable/);
    ...
    expect(() => toggleMod('/server', '/disabled-mods', 'Mod', true))
      .toThrow(/enable/);
  });
